...
<template>
    <!-- 
        Note I considered rendering this as a vue list, but changed it back
        to hard coded links. There's not really anything gained from rendering
        as a list at the moment.
    -->
    <div class="app-header flex-container">
